...
describe('LavourasComponent', () => {
  ...
  const mockLavouras = new FarmingDetailResponse();
  const mockCustoEfetivo = new CostResponse();
  const mockCustoEstimado = new CostResponse();
  const mockdesabilitarCheckbox = false;
  ...
  beforeEach(async (() => {
    ...
    component.lavouras = mockLavouras;
    component.custoEfetivo = mockCustoEfetivo;
    component.custoEstimado = mockCustoEstimado;
    component.desabilitarCheckbox = mockdesabilitarCheckbox;
  }));
